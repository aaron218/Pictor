...
public class Tutorial04 {
    public static void main(String[] args) {
        ...
        try {
            ...
            //themes: default  bigsnake  businessmachine  conqueror defrost blaster
            window.setTheme(LanternaThemes.getRegisteredTheme("default"));
            window.setDecoratedSize(new TerminalSize(125,50));
//            window.setPosition(new TerminalPosition(5,8));
            ...
            panel.setSize(new TerminalSize(20,25));
            contentPanel.addComponent(panel);
//            contentPanel.setSize(new TerminalSize(80,80));
            ...
            contentPanel.addComponent(new Button("Button", new Runnable() {
                @Override
                public void run() {
                    MessageDialog.showMessageDialog(textGUI, "MessageBox", "This is a message box" + textBox.getText(), MessageDialogButton.OK);
                }
            ...
            textBox.setSize(new TerminalSize(3,12));
            contentPanel.addComponent(textBox1);
            final ProgressBar progressBar = new ProgressBar();
            progressBar.setMax(1000);
            contentPanel.addComponent(progressBar);

            final AnimatedLabel readme =  AnimatedLabel.createClassicSpinningLine();
            contentPanel.addComponent(readme);
            contentPanel.addComponent(new Button("ReadMe", new Runnable() {
                @Override
                public void run() {
                    final MessageDialogButton dialogButton = MessageDialog.showMessageDialog(textGUI, "ReadMe",
                            "This is a README box\n " +
                                    "简单的描述一些基本信息  \n" +
                                    "每次切换主题",
                            MessageDialogButton.OK);
                        readme.startAnimation(10);
                        textBox1.setText(textBox1.getText()+progressBar.getValue()+"");
                        progressBar.setValue(progressBar.getValue() + 1);
                }
            }).setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER)));


//            final Runnable runBack = () -> {
//                for (int i = 0; i < 100 ; i++) {
//                    try {
...
//                        e.printStackTrace();
//                    }
//                    textBox.addLine(System.currentTimeMillis()+"");
//                    textBox.removeLine(0);
//                    progressBar.setValue(i);
//                }
//            };
//            new Thread(runBack).run();
