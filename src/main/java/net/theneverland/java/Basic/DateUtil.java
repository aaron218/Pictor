...
public class DateUtil {
     ...
     * "HHmm"
     */
    public static final String TIME_HHMM_NO_COLON_PATTERN = "HHmm";
    /***
     * "yyyyMMdd HH:mm:ss"
     */
    ...
    public static final SimpleDateFormat HHmm2 = new SimpleDateFormat(TIME_HHMM_NO_COLON_PATTERN);
    ...
    public static Map<String, SimpleDateFormat> getInstance(){
        ...
        if(patternFormatMap ==null){
            ...
            patternFormatMap.put(TIME_HHMM_NO_COLON_PATTERN, HHmm2);
